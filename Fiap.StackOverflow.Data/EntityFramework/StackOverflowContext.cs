...
namespace Fiap.StackOverflow.Infra.Data.EntityFramework
{
    public class StackOverflowContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        //    optionsBuilder.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\logonrmlocal\Source\fiap.mba.dev.web\Fiap.StackOverflow.Data\App_Data\dbStackOverflow.mdf;Integrated Security=True;Connect Timeout=30");
        //}
